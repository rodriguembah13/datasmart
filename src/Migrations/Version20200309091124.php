 ...
 */
final class Version20200309091124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE impl_avatar (id INT AUTO_INCREMENT NOT NULL, implementation_id INT DEFAULT NULL, question VARCHAR(255) DEFAULT NULL, answer VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_61C8AA62DF06C7D2 (implementation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
